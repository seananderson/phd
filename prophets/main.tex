...
\footnotetext[1]{ A version of this chapter appears as Anderson, S.C., A.B.
  Cooper, N.K. Dulvy. 2013. Ecological prophets: Quantifying metapopulation
...
We provide an R package ecofolio to estimate the PEs described in this
...
(Supporting materials Fig.~\ref{fig:detrend}). In particular,
...
mean-variance PEs (Supporting materials Figs~\ref{fig:detrend}, \ref{fig:meta-detrend}). Loess
detrending increased the mean-variance PE in
34/51 cases and the average-CV PE
in 34/51, lowering it in the
others (Supporting materials Figs~\ref{fig:detrend}, \ref{fig:meta-detrend-loess}). None of the
...
\citep[e.g.][]{ives2003, loreau2008, loreau2010a,
demazancourt2013}
