...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.5in]{../metafolio/inst/examples/stray-matrix}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=3.5in]{../metafolio/inst/examples/plot-various-options-ts-3pops}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.5in]{../metafolio/inst/examples/example-return-correlations}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.3in]{../metafolio/inst/examples/spatial-arma-sim-full-colour}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.3in]{../metafolio/inst/examples/spatial-arma-sim-onehalf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.3in]{../metafolio/inst/examples/spatial-linear-sim-full}
\caption{Conserving a \textbf{full range} of response diversity (spatial
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.3in]{../metafolio/inst/examples/spatial-linear-sim-onehalf}
\caption{Conserving \textbf{one half} of response diversity (spatial
conservation strategy) with \textbf{long-term} environmental change.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.3in]{../metafolio/inst/examples/n-arma-sim-2}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.3in]{../metafolio/inst/examples/n-arma-sim-16}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.3in]{../metafolio/inst/examples/n-linear-sim-2}
\caption{\textbf{Two populations} conserved with random response diversity and
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.3in]{../metafolio/inst/examples/n-linear-sim-16}
\caption{\textbf{Sixteen populations} conserved with random response diversity
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.3in]{../metafolio/inst/examples/n-linear-arma-sim-2-squeeze}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.3in]{../metafolio/inst/examples/n-linear-arma-sim-16-squeeze}
\caption{\textbf{Sixteen populations} conserved with random response diversity
and \textbf{long-term declining stream flow}.}
