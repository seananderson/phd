...
\footnotetext[2]{A version of this chapter appears as Anderson, S.C., J.W.
  Moore, M.M. McClure, N.K. Dulvy, A.B. Cooper. Portfolio conservation of
  metapopulations under climate change. Ecological Applications. In press.
...
\newcommand{\somR}{Supporting materials}
\newcommand{\somparam}{Supporting materials}
\newcommand{\somstray}{Supporting materials}
\newcommand{\somsens}{Supporting materials}
\newcommand{\somcor}{Supporting materials}
\newcommand{\somts}{Supporting materials}
...
We summarize the chosen parameter values in \somparam\ Table~\ref{t:pars}. Combining salmon population dynamics, fishing, and environmental dynamics, we illustrate the components of an example simulation in Fig.~\ref{f:ts} and the effect of varying population, fishing, and environmental parameters from their base values on metapopulation abundance in \somsens\ Fig.~\ref{f:eg-sens}.
...
\caption[Flow chart of the salmon-metapopulation simulation.]{Flow chart of
the salmon-metapopulation simulation. There are $n$ salmon populations and
$t$ generations. Blue text indicates values that are generated before the
simulation progresses through time. Red text indicates steps in which
calculations are performed through time. Black text indicates values that
are calculated. Grey text indicates parameters that can be set. Green text
indicates the looping structure of the simulation. } \label{f:flowchart}
\end{figure}
